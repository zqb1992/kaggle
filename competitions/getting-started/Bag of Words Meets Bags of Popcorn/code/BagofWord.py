...
train_data=pd.read_csv('../data/labeledTrainData.tsv',header = 0, delimiter = '\t')
test_data=pd.read_csv('../data/testData.tsv',header = 0, delimiter = '\t')
...
test_data.to_csv('../out/result.csv',index=False)